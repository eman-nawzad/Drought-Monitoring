...
# Sidebar navigation
page = st.sidebar.radio("Select a Page", ["Home", "SPI Analysis"])
...
if page == "Home":
    ...
    # Sidebar for map layers and filtering
...
elif page == "SPI Analysis":
    # Assuming 'selected_months_avg' corresponds to the selected SPI averages over time
    monthly_spi = gdf[selected_months].mean(axis=1)

    # Create a line chart
    plt.figure(figsize=(10, 6))
    plt.plot(month_columns, monthly_spi, marker='o', color='b', linestyle='-', linewidth=2)
